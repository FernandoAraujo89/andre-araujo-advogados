...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "Orientação jurídica a servidores públicos estaduais de Minas Gerais: férias-prêmio, progressão e promoção, adicional noturno e vale-transporte.",
  path: "/servidores-publicos",
});

/**
 * Hub da área Direito do Servidor Público: mesma estrutura das demais áreas,
 * com as quatro subpáginas em cards e as perguntas frequentes.
 */
